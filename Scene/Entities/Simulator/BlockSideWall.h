...
private:
    ...
    void CreateVerticesForWall(const std::vector<QVector3D> &wall, int vertexWidth, std::vector<float> &res, int scaleU,
                               int scaleV);
...
public:
    ...
    BlockSideWall(QVector3D pos, std::shared_ptr<Transform> simulatorTransform,
