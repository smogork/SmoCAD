...
std::shared_ptr<UVPlaneCreator> UVPlaneCreator::CreateRegisteredComponent(unsigned int oid, int U, int V)
{
...
std::shared_ptr<PlainC0> UVPlaneCreator::CreatePlainC0(std::shared_ptr<Transform> startPoint)
{
