...
public:
    ...
    std::vector<QVector2D> JoinConstraintPolylinesTogetherInCycle(bool startAscending = true, bool turnRight = true, int startPolylineIndex = 0, int startPolylineSegment = 0);
